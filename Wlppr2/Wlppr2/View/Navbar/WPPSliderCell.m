...
- (void)drawKnob:(NSRect)knobRect
{
    ...
    if(isPressed)
    {
        knobImage = [NSImage imageNamed:@"ZoomKnobActive"];
    }
    else {
        knobImage = [NSImage imageNamed:@"ZoomKnob"];
    }
    
    NSImage *canvas = [[NSImage alloc] initWithSize:knobRect.size];
...
- (void)drawBarInside:(NSRect)aRect flipped:(BOOL)flipped
{
	...
	NSImage *trackimg = [NSImage imageNamed:@"Zoom"];
